...
export const findAndUpdatePost = (query: FilterQuery<Post>, update: UpdateQuery<Post>, options: QueryOptions) => {
    return PostModel.findOneAndUpdate(query, update, options)
}

export const findPost = (query: FilterQuery<Post>, options: QueryOptions = { lean: true }) => {
